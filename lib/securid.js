...
var wasmBinaryFile = 'securid.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 22992, 4), 22992);function _gmtime_r(time, tmPtr) {
...
var real__stoken_compute_code = asm["stoken_compute_code"];
asm["stoken_compute_code"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__stoken_compute_code.apply(null, arguments);
};
...
var _stoken_compute_code = Module["_stoken_compute_code"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["stoken_compute_code"].apply(null, arguments)
};
